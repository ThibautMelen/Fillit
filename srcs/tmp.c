...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/04/20 21:37:58 by jroussel          #+#    #+#             */
/*   Updated: 2018/04/20 21:41:48 by jroussel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_list_print(t_list *tetriminos);
...
void		ft_list_print(t_list *tetriminos)
{
	...
	while (y < 4)
	{
		...
		while (x < 4)
		{
			printf("%d", ((int **)tetriminos->content)[x][y]);
			x++;
		}
		printf("\n");
		y++;
